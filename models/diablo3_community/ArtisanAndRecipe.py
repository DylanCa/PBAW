...
class ArtisanAndRecipe():
    ...
    def getArtisan(self, server="eu", artisanSlug='blacksmith', locale="en_US"):
    ...
    def getRecipe(self, server="eu", artisanSlug='blacksmith', recipeSlug='apprentice-flamberge', locale="en_US"):
